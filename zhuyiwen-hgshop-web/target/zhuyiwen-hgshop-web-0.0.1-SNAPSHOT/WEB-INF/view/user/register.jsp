...
<meta name="theme-color" content="#563d7c">
  ...
  <body>
    <form class="form-signin" id="registerForm"  method="post" action="../user/register">
  <div class="text-center mb-4">
    <img class="mb-4" src="${pageContext.request.contextPath}/resource/img/logo.jpg" alt="" width="72" height="72">
    <h1 class="h3 mb-3 font-weight-normal">欢迎注册豪哥商城</h1>
  </div>

  <div class="form-label-group">
    <input type="text" id="inputEmail" class="form-control" name="username" 
    placeholder="用户名称" required remote='../user/exist' >
    
  <!--   <input type="text" id="inputEmail" class="form-control" name="username" 
    placeholder="用户名称" validate="{remote:'../user/exist',messages:{remote:'重复啦拉拉'}}"  > -->
